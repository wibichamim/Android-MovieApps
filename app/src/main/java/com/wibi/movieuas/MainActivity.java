...
import com.wibi.movieuas.feature.SearchActivity;
import com.wibi.movieuas.feature.settings.SettingsActivity;
import com.wibi.movieuas.util.ATabPager;
...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_upcoming) selectTab(2);
